...
export default function ChapterIntroPage({ params }) {
      ...
      <main className="flex-1 flex flex-col items-center justify-center text-center p-8 bg-[#f4f7fa]">
        ...
        >
          <Image
            ...
            width={200}
            height={200}
            className="grayscale opacity-50 mb-6 mx-auto"
          />
  ...
  return (
    <>
            ...
            <div className="flex flex-col md:flex-row gap-10 items-start relative z-10">
              <div className="w-full md:w-1/2">
                ...
                <p className="text-slate-500 text-sm font-medium leading-relaxed mb-6">
                  ...
                  menguasai bab ini. Gunakan pengetahuanmu untuk mendapatkan
                  skor maksimal!
                </p>
      ...
      <aside className="w-[320px] bg-transparent border-l border-slate-100 hidden xl:flex flex-col p-6 space-y-6 overflow-y-auto no-scrollbar z-10 relative text-slate-800 text-slate-800">
        ...
        <div className="bg-white rounded-3xl p-6 shadow-sm border border-slate-50 text-slate-800">
          <h3 className="font-bold text-slate-800 mb-4">Materi Tersedia</h3>
          <StatRow
            label="Jumlah Soal"
